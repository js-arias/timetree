...
import (
	...
	"github.com/js-arias/timetree/cmd/timetree/filter"
	...
	"github.com/js-arias/timetree/cmd/timetree/move"
	"github.com/js-arias/timetree/cmd/timetree/newcmd"
...
func init() {
	...
	app.Add(move.Command)
	app.Add(newcmd.Command)
