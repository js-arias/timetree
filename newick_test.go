	...
	tests := map[string]treeTest{
		"ultrametric": {
			...
			nodes: []node{
				...
				{id: 1, parent: 0, age: 0, taxon: "Gallus gallus"},
				{id: 2, parent: 0, age: 176_000_000, children: []int{3, 4}},
				{id: 3, parent: 2, age: 0, taxon: "Macropus fuliginosus"},
				{id: 4, parent: 2, age: 25_000_000, children: []int{5, 6}},
				{id: 5, parent: 4, age: 0, taxon: "Homo sapiens"},
				{id: 6, parent: 4, age: 0, taxon: "Macaca mulatta"},
			},
			terms: []string{
				"Gallus gallus",
				"Homo sapiens",
		...
		"non ultrametric": {
			...
			nodes: []node{
				...
				{id: 1, parent: 0, age: 230_000_000, taxon: "Eoraptor lunensis"},
				{id: 2, parent: 0, age: 230_000_000, children: []int{3, 6}},
				{id: 3, parent: 2, age: 170_000_000, children: []int{4, 5}},
				{id: 4, parent: 3, age: 145_000_000, taxon: "Ceratosaurus nasicornis"},
				{id: 5, parent: 3, age: 71_000_000, taxon: "Carnotaurus sastrei"},
				{id: 6, parent: 2, age: 170_000_000, children: []int{7, 8}},
				{id: 7, parent: 6, age: 68_000_000, taxon: "Tyrannosaurus rex"},
				{id: 8, parent: 6, age: 160_000_000, children: []int{9, 10}},
				{id: 9, parent: 8, age: 150_000_000, taxon: "Archaeopteryx lithographica"},
				{id: 10, parent: 8, age: 0, taxon: "Passer domesticus"},
			},
			terms: []string{
		...
		"no present taxon": {
			...
			nodes: []node{
				...
				{id: 2, parent: 0, age: 230_000_000, children: []int{3, 6}},
				{id: 3, parent: 2, age: 170_000_000, children: []int{4, 5}},
				{id: 4, parent: 3, age: 150_000_000, taxon: "Archaeopteryx lithographica"},
				{id: 5, parent: 3, age: 68_000_000, taxon: "Tyrannosaurus rex"},
				{id: 6, parent: 2, age: 170_000_000, children: []int{7, 8}},
				{id: 7, parent: 6, age: 145_000_000, taxon: "Ceratosaurus nasicornis"},
				{id: 8, parent: 6, age: 71_000_000, taxon: "Carnotaurus sastrei"},
			},
			terms: []string{
				"Archaeopteryx lithographica",
				"Carnotaurus sastrei",
		...
		"zero length branch": {
			...
			nodes: []node{
				...
				{id: 1, parent: 0, age: 0, taxon: "A"},
				{id: 2, parent: 0, age: 9_999_999, children: []int{3, 4}},
		...
		"mesquite tree": {
			...
			nodes: []node{
				...
				{id: 1, parent: 0, taxon: "C"},
				{id: 2, parent: 0, age: 1_000_000, children: []int{3, 4}},
